...
const Bookmark = () => {
  ...
  if (!loggedInUser?.bookmarks?.length) {
    return (
      <div className="border-x-[1px] border-zinc-800 w-[50%] h-screen overflow-y-auto mx-8 text-center">
        ...
        <div className="flex w-full justify-center mt-5">
          <Link
            to="/"
            className=" text-2xl rounded-full w-fit px-8 hover:scale-110 py-3 hover:bg-zinc-800"
          >
            Explore
          </Link>
        </div>
